...
static struct dvfs dvfs_init[] = {
	 ...
	 */
	CORE_DVFS("usb2min", -1, 1, KHZ, 60000,  60000,  60000,  60000,  60000,  60000,  60000,  60000,  60000),
	CORE_DVFS("usb3",    -1, 1, KHZ, 0,      0,      480000, 480000, 480000, 480000, 480000, 480000, 480000),
	CORE_DVFS("usb3min", -1, 1, KHZ, 60000,  60000,  60000,  60000,  60000,  60000,  60000,  60000,  60000),
